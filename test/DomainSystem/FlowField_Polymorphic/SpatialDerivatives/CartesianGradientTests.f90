module CartesianGradientTests
  ...
  character(*), parameter :: MOD_NAME = 'CartesianGradientTests'
...
contains
  ...
  subroutine setUp
    ...
    call createFirstSpatialDerivative( directedSpatialDerivative, 1, &
         log )
  ...
  subroutine testRow_OnePoint
    ...
    expected = [0.00000_FLOAT, 5.06250_FLOAT, 13.50000_FLOAT, &
         27.00000_FLOAT, 48.00000_FLOAT, 80.00000_FLOAT]
    do i = 1, 6
       call assertEqual( expected(i), actual(1, i), 'Element '//str(&
            i)//' failed.')
    end do
  end subroutine testRow_OnePoint

  
end module CartesianGradientTests
